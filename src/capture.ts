...
export function resolveCapture(input: Partial<CapturePolicy> | undefined): CapturePolicy {
...
export function applyCapture(event: BoundaryLogEvent, capture: CapturePolicy): BoundaryLogEvent {
